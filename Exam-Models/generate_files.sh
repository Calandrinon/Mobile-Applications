...
#
# In order to generate the backend routes properly, import the router manually into the index.js file and set the protected routes accordingly (i.e add a new line which calls the .use method on the protectedApiRouter object).
