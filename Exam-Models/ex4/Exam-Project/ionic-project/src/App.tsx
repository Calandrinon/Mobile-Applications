...
import {TasksSearch} from "./tasks/TaskSearch";
                    ...
                    <IonTabs>
                        <IonRouterOutlet>
                            ...
                            <ItemProvider>
                                ...
                                <PrivateRoute path="/searchTasks" component={TasksSearch} exact={true}/>
                            </ItemProvider>
                        ...
                        <IonTabBar slot="bottom" color="success">
                            ...
                            <IonTabButton tab="tasksTab" href="/searchTasks">
                                <IonIcon icon={pricetagsOutline} /> Search tasks
                            </IonTabButton>
                        </IonTabBar>
                    </IonTabs>
                </AuthProvider>
